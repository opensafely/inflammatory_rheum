...
/*==============================================================================
DO FILE NAME:			Produce temporal plots from GCA dataset
PROJECT:				Inflammatory Rheum OpenSAFELY project
DATE: 					20/05/2025
AUTHOR:					M Russell									
DESCRIPTION OF FILE:	Temporal plots for GCA cohort 
...
global arglist studystart_date studyend_date studyfup_date intervention_date
args $arglist
...
cap log close
log using "$logdir/${disease}_plots.log", replace
...
foreach table in postdiagnosis baseline {

	**Import rounded and redacted data tables
	import delimited "$projectdir/output/tables/gca_datatable_`table'.csv", clear
	di "`table'"
